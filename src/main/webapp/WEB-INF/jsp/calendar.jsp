        ...
        function generateCalendar(year, month,data) {
            ...
            for (let i = 0; i < 6; i++) {
                ...
                for (let j = 0; j < 7; j++) {
                 ...
                 atag.href= "/EmpCtrl/particular-day";
                   ...
                   if(data!=null){
                    for(k=0;k< data.length;k++){
                       ...
                       var dayab= dateforab.substring(4,6);
                ...
                "July", "August", "September", "October", "November", "December"
                     ...
                     var pday = new Date(yearab,mindex,dayab).getDay();
                      
                      console.log(currentYear , yearab);
                       console.log(currentMonth , months);
                       console.log(day , dayab);
                       console.log(months);
                       console.log("particular day got " ,forpday);
                  

          if(currentYear == yearab && currentMonth == mindex && day == dayab){
            dayarray[k] = dayab;
            cell.style.backgroundColor = "lightblue";
            console.log("color should be present");
          }
